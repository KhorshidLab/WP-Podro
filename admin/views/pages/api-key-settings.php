...
<div class="wrap pod-wrap">
	...
	<div class="pdo-wrapper">
		<div class="pdo-card">
			<h1><?php echo esc_html_e( 'تنظیمات عمومی پادرو', PODRO_TEXTDOMAIN ) ?></h1>
			<h3><?php echo esc_html_e( 'پیکربندی اتصال به پادرو پین', PODRO_TEXTDOMAIN ) ?></h3>
			<form class="wp_podro-config-form" method="post" action="<?php echo esc_url(admin_url( '/admin.php?page=wp_podro' )); ?>">
				...
				<h3><?php echo esc_html_e( 'تنظیمات فروشگاه', PODRO_TEXTDOMAIN ) ?></h3>
				<div class="pdo-box">
				...
				<div class="pdo-box">
					<a class="get-api-key" href="https://podro.com/plugin-pin/" target="_blank" rel="noopener noreferrer"><?php echo esc_html_e('دریافت کلید API', PODRO_TEXTDOMAIN); ?></a>
				</div>
				<button type="submit" class="button button-primary" name="config_podro_api_key" value="1"><?php echo esc_html_e( "ذخیره", PODRO_TEXTDOMAIN ) ?></button>
			</form>
		</div>
